...
parser.add_argument("rm_run_id", type=str, help="display a square of a given number")
...
DEVICE = "cuda"
CHOSEN_MODEL = "microsoft/phi-1_5"  # "unsloth/Qwen2-7B-Instruct-bnb-4bit"  #   # "Qwen/Qwen2-7B-Instruct"
...
RM_TRAIN_DATA_RUN_ID = args.rm_run_id  # "95620e03ef074d429ff5df1070f5c715"
print(f'Will train RL model with RM id: {RM_TRAIN_DATA_RUN_ID}')

RL_LORA_PARAM_R = 16
RL_LORA_PARAM_ALPHA = 16
RL_LORA_PARAM_TARGET_MODULES = LORA_PARAM_TARGET_MODULES[CHOSEN_MODEL]
RL_TRAIN_BATCH_SIZE = 20
RL_TRAIN_MINI_BATCH_SIZE = 4
RL_LEARNING_RATE = 1.41e-9
RL_N_EPOCHS = 1
